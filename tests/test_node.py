...
def test_add_file_to_dir():
    ...
    root_node.insert("./src/test.py","file","316070e1e044c6f1b3659507bbbc3ad56524816a")
    ...
    assert root_node.getSha("./src/test.py") == "316070e1e044c6f1b3659507bbbc3ad56524816a"
